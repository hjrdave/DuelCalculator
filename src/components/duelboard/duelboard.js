...
class Duelboard extends Component {
  ...
  handleView = (value) => {
    ...
    this.props.handleAnimationState("default");
   //alert(this.props.AnimationState);
  }
...
componentDidMount(){
  if(this.props.AnimationState === "default"){
    //utility bar animation
    Velocity(document.getElementById("UtilityBar"),{ opacity: [1,0], scale: [1, 2]},{duration:600,delay:800});
 ...
 //Handles DuelBoard animations
  componentDidUpdate(){
    if(this.props.AnimationState === "reset"){
      //utility bar animation
    ...
    else if(this.props.AnimationState === "default"){
      //player card animation
