        ...
        <>
            <Navbar className={`${styles.header} d-flex justify-content-between`}>
                <Navbar.Text className={`px-3 ${styles.navbarText}`}>
                    <i className={`fa-solid fa-circle-info cursor ${styles.settingsIcon}`} onClick={board.goToAbout}></i>
                </Navbar.Text>
                <Navbar.Brand className={`${styles.navbarBrand} cursor`} onClick={board.goToHome}><div>DuelCalculator.js</div></Navbar.Brand>
